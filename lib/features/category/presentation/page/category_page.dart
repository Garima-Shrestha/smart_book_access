            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, bookIndex) {
                  ...
                  final myLibraryState = ref.watch(myLibraryViewModelProvider);
                  final rentedEntry = myLibraryState.books.where(
                        (b) => b.bookId == book.bookId,
                  ).toList();
                  final isRented = rentedEntry.isNotEmpty &&
                      !rentedEntry.first.isExpired &&
                      !rentedEntry.first.isInactive;
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        if (bookId == null || bookId.isEmpty) {
                          SnackbarUtils.showError(context, "Invalid book id");
                          return;
                        }

                        final myLibraryState = ref.read(myLibraryViewModelProvider);
                        final rentedEntry = myLibraryState.books.where(
                              (b) => b.bookId == bookId,
                        ).toList();
                        final hasActiveRent = rentedEntry.isNotEmpty &&
                            !rentedEntry.first.isExpired &&
                            !rentedEntry.first.isInactive;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            isRented ? "READ NOW" : "AVAILABLE TO RENT",
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                              color: isRented
...
//                         );
//
//                         await ref.read(bookAccessViewModelProvider.notifier).fetchBookAccess(bookId);
//
//                         if (context.mounted) Navigator.pop(context);
//
//                         final accessState = ref.read(bookAccessViewModelProvider);
//
//                         if (accessState.status == BookAccessStatus.loaded &&
//                             accessState.bookAccess != null &&
//                             (accessState.bookAccess!.pdfUrl ?? "").isNotEmpty) {
//                           Navigator.push(
//                             context,
//                             MaterialPageRoute(
//                               builder: (_) => PdfReaderPage(
...
//                         );
//
//                         ref.read(bookAccessViewModelProvider.notifier).clearError();
//                       },
//                       child: Column(
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
